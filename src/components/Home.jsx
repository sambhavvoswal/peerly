    ...
    <div>
      ...
      >
        ...
        <div className="absolute top-6 left-6 z-20">
          <span className="text-violet-400 font-montserrat font-semibold text-3xl tracking-tight">
            Peerly
          </span>
        </div>
        ...
        <div className="flex flex-col items-center justify-center h-full w-full px-4 z-10">
          ...
          {!hasJoined && (
            ...
            >
              <input
                ...
                style={{
                  boxShadow: "0 0 12px 2px #a78bfa, 0 0 24px 4px #8b5cf6",
                }}
              />
              <button
                type="submit"
          ...
          {hasJoined && (
            <div
              id="message"
              className="mt-4 text-center text-white font-montserrat font-semibold text-2xl sm:text-3xl md:text-4xl drop-shadow-lg"
            >
              {message ||
                "✅ You’re already on the waiting list with this email."}
            </div>
          )}
        </div>
      </section>
